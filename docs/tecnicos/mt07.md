...
Surge el primer error en el código, no coincide el puerto serie COM5 con el código importado, es peciso modificar el COM 3 a COM 5. Volvemos a cargar y el error se soluciona.

![](../images/MT07/c1.png)

![](../images/MT07/c4.png)

Se genera una interficie color rojo, a partir de la lectura del sensor. Para ver que valores me están dando, cerramos processing y volvemos a arduino:
