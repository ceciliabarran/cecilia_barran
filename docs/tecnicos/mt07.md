...
En este caso se conecta arduino con la web, mediante "WebSocket". En este caso la información no va por serie, como el ejemplo de processing, sino que va por web.
