...
La interficie generada es muy sensilla, sería más útil si no tuviera el sistema de autoriego y el cambio de color implicara un accion en el usuario, es decir: 
