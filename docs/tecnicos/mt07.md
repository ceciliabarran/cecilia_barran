...
La interficie generada es muy sensilla, sería más útil si no tuviera el sistema de autoriego y el cambio de color implicara un acción en el usuario, es decir: 
> - Si luz VERDE, sustrato húmedo, todo ok no hay acción necesaria.
> - Si luz ROJO, sustrato seco, REGAR! hasta ver luz VERDE.
