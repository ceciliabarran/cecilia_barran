...
<a class="btn" href="/docs/files/MTO9.f3d" download="molde de maceta en fusion">
...
<head>
    ...
    <title>Descargar archivo .f3d</title>
</head>
<body>
    <h1>Descarga tu archivo .f3d</h1>
    
    <!-- Enlace de descarga -->
    <a href="C:\Users\User\Desktop\EFDI\cecilia_barran\docs\files\MTO9.f3d" download="archivo.f3d">Descargar archivo</a>
" download="archivo.f3d">
        Haz clic aquí para descargar el archivo .f3d
    </a>
