...
Para corregir el error, en el archivo RDworks, modificamos las capas, pasando todo en amarillo (color que NO se va a imprimir) y luego los bordes que no se habian cortado completamente en color rojo. Indicando que vuelva a cortar las piezas en color rojo.
