...
Una vez que el extrusor (pico) y la cama llegan a la temperatura deseada, se ejecuta el archivo g code y la máquina realiza los movimientos para empezar a imprimir la pieza.

<div style="padding:56.25% 0 0 0;position:relative;"><iframe src="https://player.vimeo.com/video/1029383587?title=0&amp;byline=0&amp;portrait=0&amp;badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479" frameborder="0" allow="autoplay; fullscreen; picture-in-picture; clipboard-write" style="position:absolute;top:0;left:0;width:100%;height:100%;" title="20240726_161146"></iframe></div><script src="https://player.vimeo.com/api/player.js"></script> 
...
Sinembargo el lado el lado que no tuvo soportes quedó perfecto, si es esta la cara de la pieza que quedará visible, es una terminación aceptable. </font>
