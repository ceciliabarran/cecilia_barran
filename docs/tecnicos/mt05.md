...
En la pestaña Preparar para laminar, determiné la altura de la capa, 0.2mm, siguiendo las especificaciones de la actividad. La altura de la capa define la calidad del objeto:
