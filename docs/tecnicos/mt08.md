...
La herramienta que utiliza la máquina es una **fresa**, con la cual puede realizar operaciones de perforado, como una mecha, pero ademas realizar operaciones de tallado.
